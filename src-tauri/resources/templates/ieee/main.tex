...
\author{%
\IEEEauthorblockN{Ashish Vaswani\IEEEauthorrefmark{1}\thanks{\IEEEauthorrefmark{1}Equal contribution. Listing order is random.}\quad Noam Shazeer\IEEEauthorrefmark{1}\quad Niki Parmar\IEEEauthorrefmark{1}\quad Jakob Uszkoreit\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\textit{Google Brain / Google Research} \\
\{avaswani, noam, nikip, usz\}@google.com}
% Stack both groups in one centered column; \and starts a separate column.
\IEEEauthorblockN{Llion Jones\IEEEauthorrefmark{1}\quad Aidan N. Gomez\IEEEauthorrefmark{1}\quad {\L}ukasz Kaiser\IEEEauthorrefmark{1}\quad Illia Polosukhin\IEEEauthorrefmark{1}}
