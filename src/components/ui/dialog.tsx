...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      ...
      // A closed dialog is still mounted while it animates out, and this
      // webview does not always deliver the animationend that unmounts it.
      // Whatever is left behind must not swallow clicks or hit tests.
