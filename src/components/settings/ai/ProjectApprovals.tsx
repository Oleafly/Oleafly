          ...
          {rules.map(([tool, decision]) => (
            ...
            >
              ...
              <span
                className={
                  decision === "allow"
                    ? "rounded-full bg-success-soft px-1.5 py-0.5 text-[10px] font-medium text-success-strong"
                    : "rounded-full bg-danger-soft px-1.5 py-0.5 text-[10px] font-medium text-danger-strong"
                }
              >
