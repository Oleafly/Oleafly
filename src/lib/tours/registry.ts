  ...
  settings: {
    ...
    steps: [
      ...
      },
      {
        ...
        kind: "transition",
        title: "AI Assistant",
        content: "Configure providers, models, credentials, and the MCP servers the assistant can use.",
        waitForTarget: true,
        placement: "left",
      },
      {
      ...
      },
      {
        ...
        kind: "transition",
        title: "Integrations",
        content: "Connect GitHub, alphaXiv, Zotero, citation search, and Oleafly's local MCP server.",
        waitForTarget: true,
        placement: "left",
      },
      {
    ...
    steps: [
      {
        ...
        content: "Manage providers and keys, instructions, personas, reusable skills, and MCP servers here.",
        waitForTarget: true,
      },
      {
