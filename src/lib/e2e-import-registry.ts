...
const registry: Record<string, () => Promise<unknown>> = !E2E_HOOKS ? {} : {
  ...
  "/src/lib/project-intelligence/current.ts": () => import("@/lib/project-intelligence/current"),
  ...
  "/src/store/visual-mode.ts": () => import("@/store/visual-mode"),
  "/packages/editor/src/bibtex-linter.ts": () => import("../../packages/editor/src/bibtex-linter"),
  ...
  "/packages/editor/src/latex-linter.ts": () => import("../../packages/editor/src/latex-linter"),
