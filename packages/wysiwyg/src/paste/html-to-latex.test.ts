...
const CASES: [name: string, html: string, expected: string][] = [
  ...
  [
    "Czech and French ties",
    "<p>Hrany končí v&nbsp;místě a&nbsp;<b>na</b> okraji. Il dit&nbsp;: «&nbsp;oui&nbsp;»</p>",
    "Hrany končí v~místě a~\\textbf{na} okraji. Il dit~: «~oui~»",
  ],
  ["non-breaking space runs", "<p>a&nbsp;&nbsp;b c&nbsp; d</p>", "a b c d"],
  ["non-breaking space only paragraph", "<p>first</p><p>&nbsp;</p><p>second&nbsp;</p>", "first\n\nsecond"],
  ["non-breaking space in inline code", "<p>Use <code>a&nbsp;b</code> v&nbsp;kódu</p>", "Use \\verb|a b| v~kódu"],
  ["non-breaking space in multi-line code", "<p><code>a&nbsp;b\nc</code></p>", "\\texttt{a b c}"],
