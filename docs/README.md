...
This directory contains public references for contributors, integrators, and
people evaluating Oleafly's product boundaries. It describes architecture,
implementation contracts, supported engines, integrations, and release
operations. The pages below are inventories and engineering contracts, not
end-user tutorials.
...
| System design | [Product architecture](architecture.md), [Realtime protocol v1](realtime/protocol-v1.md), [Desktop Source collaboration test](realtime/desktop-source-slice.md), [Architecture decisions](decisions/0001-local-first-realtime-collaboration.md), [Development](development.md), [Language-server toolchain](language-server-toolchain.md) |
