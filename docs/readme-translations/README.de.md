...
[![Offene Issues](https://img.shields.io/github/issues/Oleafly/Oleafly?label=issues&color=22c55e)](https://github.com/Oleafly/Oleafly/issues) [![Downloads](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2FOleafly%2FOleafly%2Fbadges%2F.github%2Fbadges%2Fdownloads.json)](https://github.com/Oleafly/Oleafly/releases) [![CI](https://github.com/Oleafly/Oleafly/actions/workflows/release.yml/badge.svg)](https://github.com/Oleafly/Oleafly/actions/workflows/release.yml) [![Lizenz: AGPL v3](https://img.shields.io/badge/License-AGPL_v3-22c55e.svg)](../../LICENSE) [![Sterne](https://img.shields.io/github/stars/Oleafly/Oleafly?style=social)](https://github.com/Oleafly/Oleafly)
...
Oleafly ist eine kostenlose Open-Source-App zum wissenschaftlichen Schreiben. Nutze sie für Paper, Dissertationen, Berichte, Präsentationen, Bücher, Lebensläufe und andere technische Dokumente. Arbeite in LaTeX, Typst oder Markdown. Quelltext, PDF, Zitate, Abbildungen, Prüfungen, Git-Historie und optionale KI-Werkzeuge bleiben im selben Projekt.

<p>
  <a href="https://github.com/Oleafly/Oleafly/releases/latest"><strong>Kostenlos herunterladen</strong></a>
· <a href="https://oleafly.com/docs/">Anleitungen lesen</a> · <a href="../development.md">Aus dem Quellcode bauen</a>
</p>
...
| eine Abbildung oder Tabelle erstellst | Diagram Composer, LaTeX Preview, Image to LaTeX oder LaTeX Table Generator |
...
<p align="center"><em>Beginne mit der Art Arbeit, die du tatsächlich vor dir hast: einem neuen Forschungsprojekt, einem bestehenden Projekt oder einer Vorlage.</em></p>

## Warum Oleafly

Die meisten Workflows für wissenschaftliches Schreiben bestehen aus einer Kette getrennter Werkzeuge: Editor, Compiler, PDF-Reader, Literaturverwaltung, Diagrammwerkzeug, Git, Prüfliste und vielleicht ein KI-Chat, der das Projekt nicht sehen kann. Gerade wenn die Argumentation kompliziert wird, verteilt sich die Arbeit über mehrere Fenster.

Oleafly hält diese Werkzeuge in einem Projekt zusammen. Der Quelltext bleibt einfacher Text, das PDF liegt daneben. Du kannst aus dem Satz vor dir ein Zitat suchen, eine Abbildung als TikZ behalten und die Änderungen eines Assistenten prüfen, bevor sie ins Projekt gelangen.

### Drei Arten zu arbeiten

| Workflow | Das bekommst du | Was du weiterhin lösen musst |
| --- | --- | --- |
| Gehosteter Cloud-Editor | Schneller Einstieg, Browserzugriff und ein verwalteter Dienst | Einer gehosteten Datenebene vertrauen und deinen Workflow an ihre Grenzen anpassen |
| Lokaler Eigenbau-Stack | Kontrolle über Dateien, Werkzeuge und Infrastruktur | Jedes einzelne Teil auswählen, installieren, konfigurieren und warten |
| Oleafly | Ein lokaler Desktop-Arbeitsbereich mit Editor, Engines, PDF, Zitaten, Abbildungen, Prüfungen, Git und optionalen Agenten an einem Ort | Live-Zusammenarbeit und Hintergrundsynchronisierung zwischen Geräten sind in dieser Version nicht enthalten |

Oleafly bietet dir einen geführten Arbeitsbereich, ohne dein Manuskript in ein proprietäres Format oder einen dauerhaften Dienst einzuschließen.
...
<p align="center"><em>Anbieter-Verbindungen sind ausdrücklich und vom Manuskript auf der Festplatte getrennt.</em></p>

## Mit einem echten Projekt beginnen
...
<div align="center">
  <img src="../assets/readme/template-downloads.png" alt="Oleafly-Vorlagendownloads mit Paketen für wissenschaftliches Schreiben, Beamer und Konferenzvorlagen" width="100%" />
</div>
...
<p align="center"><em>Bringe ein bestehendes Projekt oder Dokument in einen normalen lokalen Arbeitsbereich.</em></p>

### Jedes Projekt ist ein zugänglicher Ordner auf deiner Festplatte

Oleaflys Bibliothek verfolgt Projektidentität, Engine, Dokumentart, Lesezeichen, Vorschauzustand und Historie. Das Manuskript selbst bleibt ein normaler Ordner. Der Quelltext kann in einem anderen Editor geöffnet, im Terminal geprüft, mit einem Mitautor geteilt oder mit normalem Git committed werden. Oleafly benötigt keine proprietäre Dokumentdatenbank, um deine Arbeit zu kompilieren.

Die App hält ihre eigenen Build-Artefakte und lokalen Metadaten vom Quelltext getrennt. Ein Projekt kann seine Engine- und Hauptdokumentauswahl in `project.json` speichern, sodass ein Klon oder Quellarchiv mit denselben Projekteinstellungen geöffnet werden kann.

<div align="center">
  <img src="../assets/readme/project-library.png" alt="Oleafly-Projektbibliothek mit Forschungsprojekten in einer durchsuchbaren Liste" width="100%" />
</div>

## Die Arbeit schreiben und ihre Struktur behalten

### Ein Quelltexteditor für strukturierte Dokumente

Der CodeMirror-Editor wird von einem projektweiten Index unterstützt. Der Index umfasst Überschriften, Labels, Zitierschlüssel, Makros, Umgebungen, eingebundene Dateien und Kompilierungsdiagnosen im gesamten Manuskript.
...
<p align="center"><em>Erstelle ein strukturiertes LaTeX-Dokument über die Werkzeugleiste und bearbeite anschließend den Quelltext direkt weiter.</em></p>
...
| --- | ---: | --- |
| Griechisch klein | 29 | `\alpha`, `\beta`, `\gamma`, `\delta`, `\epsilon`, `\varepsilon`, `\zeta`, `\eta`, `\theta`, `\vartheta`, `\iota`, `\kappa`, `\lambda`, `\mu`, `\nu`, `\xi`, `\pi`, `\varpi`, `\rho`, `\varrho`, `\sigma`, `\varsigma`, `\tau`, `\upsilon`, `\phi`, `\varphi`, `\chi`, `\psi`, `\omega` |
| Griechisch groß | 11 | `\Gamma`, `\Delta`, `\Theta`, `\Lambda`, `\Xi`, `\Pi`, `\Sigma`, `\Upsilon`, `\Phi`, `\Psi`, `\Omega` |
| Operatoren | 19 | `+`, `-`, `\times`, `\div`, `\cdot`, `\pm`, `\mp`, `\ast`, `\star`, `\circ`, `\bullet`, `\oplus`, `\ominus`, `\otimes`, `\odot`, `\dagger`, `\ddagger`, `\nabla`, `\partial` |
| Relationen | 21 | `=`, `\neq`, `<`, `>`, `\leq`, `\geq`, `\ll`, `\gg`, `\approx`, `\sim`, `\simeq`, `\cong`, `\equiv`, `\propto`, `\prec`, `\succ`, `\preceq`, `\succeq`, `\perp`, `\parallel`, `\mid` |
| Pfeile | 23 | `\leftarrow`, `\rightarrow`, `\uparrow`, `\downarrow`, `\leftrightarrow`, `\Leftarrow`, `\Rightarrow`, `\Uparrow`, `\Downarrow`, `\Leftrightarrow`, `\mapsto`, `\longmapsto`, `\longrightarrow`, `\longleftarrow`, `\hookrightarrow`, `\hookleftarrow`, `\nearrow`, `\searrow`, `\nwarrow`, `\swarrow`, `\rightleftharpoons`, `\leftharpoonup`, `\rightharpoonup` |
...
| Logik | 16 | `\forall`, `\exists`, `\nexists`, `\neg`, `\land`, `\lor`, `\wedge`, `\vee`, `\implies`, `\iff`, `\therefore`, `\because`, `\top`, `\bot`, `\vdash`, `\models` |
| Analysis | 18 | `\int`, `\iint`, `\iiint`, `\oint`, `\sum`, `\prod`, `\coprod`, `\lim`, `\infty`, `\nabla`, `\partial`, `\sqrt{}`, `\frac{}{}`, `\binom{}{}`, `\sup`, `\inf`, `\max`, `\min` |
| Funktionen | 19 | `\sin`, `\cos`, `\tan`, `\cot`, `\sec`, `\csc`, `\arcsin`, `\arccos`, `\arctan`, `\sinh`, `\cosh`, `\tanh`, `\log`, `\ln`, `\exp`, `\det`, `\dim`, `\ker`, `\arg` |
| Klammern | 16 | `(`, `)`, `[`, `]`, `\{`, `\}`, `\langle`, `\rangle`, `\lfloor`, `\rfloor`, `\lceil`, `\rceil`, vertikaler Strich als Literal, `\|`, `\left( \right)`, `\left[ \right]` |
| Akzente | 14 | `\hat{}`, `\bar{}`, `\tilde{}`, `\vec{}`, `\dot{}`, `\ddot{}`, `\acute{}`, `\grave{}`, `\breve{}`, `\check{}`, `\overline{}`, `\underline{}`, `\overbrace{}`, `\underbrace{}` |
| Punkte und Abstände | 13 | `\cdots`, `\ldots`, `\vdots`, `\ddots`, `\quad`, `\qquad`, `\,`, `\;`, `\!`, `\text{}`, `\mathrm{}`, `\mathbf{}`, `\mathcal{}` |
| Sonstiges | 20 | `\hbar`, `\ell`, `\wp`, `\Re`, `\Im`, `\aleph`, `\angle`, `\triangle`, `\diamond`, `\square`, `\lozenge`, `\clubsuit`, `\diamondsuit`, `\heartsuit`, `\spadesuit`, `^{\circ}`, `\#`, `\$`, `\%`, `\&` |

<div align="center">
  <img src="../assets/readme/latex-symbols.png" alt="Oleafly-LaTeX-Symbolpalette mit durchsuchbaren Kategorien für griechische Buchstaben, Operatoren, Relationen, Pfeile, Mengenlehre, Logik, Analysis, Funktionen, Klammern, Akzente, Abstände und Sonstiges" width="100%" />
</div>
<p align="center"><em>Durchsuche 236 eindeutige LaTeX-Befehle nach Kategorie oder Name und füge den benötigten ein.</em></p>

<div align="center">
  <img src="../assets/readme/source-and-pdf.png" alt="Oleafly mit Manuskript-Quelltext und kompiliertem PDF zusammen" width="100%" />
</div>
...
<p align="center">
  <img src="../assets/readme/visual-editor.png" alt="Oleafly-Visual-Editor mit seitenorientiertem Manuskript, Dateibaum und Gliederung" width="100%" />
</p>

### Prosa lokal Korrektur lesen
...
<div align="center">
  <img src="../assets/readme/compile-engines.png" alt="Oleafly-Engine-Einstellungen mit LaTeX-, Typst-, Markdown- und verwalteten TeX-Distributionen" width="100%" />
</div>
...
Im Dokumentmodus teilt Oleafly die aktuelle Auswahl oder das Manuskript in Prosaparagraphen auf, durchsucht konfigurierte Literaturquellen, entfernt bereits in der Bibliografie enthaltene Arbeiten und bewertet den Rest auf einer Skala von 0 bis 100. Ein KI-Anbieter kann kurze FOR / AGAINST-Begründungen hinzufügen. Bei ausgeschalteter KI verwendet die Prüfung eine lokale heuristische Rangfolge.

Speichere Ergebnisse in der lokalen Zitatbibliothek, kopiere BibTeX oder hänge einen ausgewählten Eintrag an eine Projektbibliografie an und füge sein Zitat ein.

### Eine Arbeit aus zwei Perspektiven begutachten

Der Review-Modus kann einen konfigurierten KI-Anbieter verwenden, um das aktuelle Dokument oder eine erfasste Auswahl in zwei Stilen zu lesen:

- Friendly: zuerst die Stärken, danach konkrete und konstruktive Vorschläge.
- Fire: ein strenger Reviewer-#2-Stresstest von Behauptungen, Methoden und Belegen.

Die Begutachtung ist eine optionale Assistentenaktion. Sie ersetzt weder die Richtlinien des Venues noch einen menschlichen Mitautor.

### Forschungsordner neben dem Manuskript behalten

Verknüpfe ein Dataset, eine Quellenbibliothek, einen Analyseordner oder ein anderes Forschungsverzeichnis, ohne es in das Projekt zu verschieben. Oleafly liest verknüpfte Ordner und schreibt nie in sie. Sie bleiben von Kompilierung, Projektsuche und Git ausgeschlossen; fehlt ein Pfad oder ist er nicht lesbar, wird das klar angezeigt.
...
| --- | --- |
| Kompilierung und Layout | Fehlgeschlagene Builds, ungelöste Zitate und Referenzen, Warnungen zu erneuten Läufen, fehlende Glyphen, übervolle Boxen, abgeschnittenen Text, doppelte PDF-Ziele und gemischte Seitengrößen |
| Einreichungsbereitschaft | Dokumentklasse, Abstract, Schlüsselwörter, Abbildungsformate, eingebettete Schriften, PDF-Version und -Beschränkungen, portable Dateinamen, Beschriftungen und eine saubere Quelltextverpackung |
| ATS-Bereitschaft | Textextraktion aus dem Lebenslauf, Kontaktfelder, erwartete Abschnitte, Seitenlänge und Layouts, die Bewerber-Tracking-Systeme häufig durcheinanderbringen |
| Barrierefreiheit | Tags, Alt-Text, Dokumentsprache und -titel, Viewereinstellungen, Überschriften- und Tabellenstruktur, Linkbeschreibungen, Lesereihenfolge, auswählbarer Text, Lesezeichen und sehr kleine Schrift |
| Referenzen und Assets | Fehlende Dateien, nicht definierte Zitate und Querverweise, doppelte Labels und DOIs, unvollständige Bibliografiefelder, nicht zitierte Einträge und fehlende Abbildungen |
| Datenschutz und Blindbegutachtung | Zugangsdaten, private Schlüssel, sensible Dateien, Entwurfs-Markup, interne Kommentare, Autorenfelder, Danksagungen und Identitätsmetadaten des PDFs |
...
<div align="center">
  <img src="../assets/readme/preflight-accessibility.png" alt="Oleafly-Preflight-Barrierefreiheitsprüfungen mit maschinell prüfbaren Befunden" width="100%" />
</div>
<p align="center"><em>Preflight macht maschinell prüfbare Barrierefreiheitsbefunde vor der Einreichung sichtbar; die Funktion selbst beansprucht keine Konformität.</em></p>

## Versionieren und Arbeit wiederherstellen
...
<p align="center"><em>Sieh vorgemerkte Änderungen, Branches, Historie und Commits, ohne das Projekt zu verlassen.</em></p>

### Checkpoints für schnelle Wiederherstellung nutzen

Nach einer erfolgreichen Kompilierung kann Oleafly einen lokalen Snapshot des Projekts speichern. Checkpoints initialisieren kein Repository, erstellen keine Commits und ändern keinen Branch. Stelle einen früheren Zustand transaktional wieder her, beschrifte eine wichtige Version, prüfe gespeicherte Dateien, kürze alte Historie oder verschiebe eine vollständige Historie in ein verschlüsseltes Archiv.

Nutze Git für bewusste Commits, Branches, Remotes und Zusammenarbeit. Nutze Checkpoints für die schnelle lokale Wiederherstellung, während sich eine Arbeit rasch verändert.

<div align="center">
  <img src="../assets/readme/checkpoints.png" alt="Oleafly-Versionierungsansicht mit gespeicherten Checkpoints und Git-Historie" width="100%" />
</div>

## KI ist optional

Editor, Compiler, PDF-Vorschau, Zitate, Korrektur und Preflight funktionieren mit ausgeschalteter KI. Wenn KI aktiviert ist, verwendet sie dieselben Projektdateien und Werkzeuge wie der Rest der App.

### Einen Assistenten zum geöffneten Projekt befragen

Mit einem konfigurierten Anbieter kann der Assistent:

- Eine Projektdatei lesen oder das Projekt durchsuchen, bevor er antwortet.
- Einen Abschnitt, eine Gleichung, ein Zitat oder einen Kompilierungsfehler erklären.
...
<div align="center">
  <img src="../assets/readme/ai-personas.png" alt="Oleafly-KI-Assistentenrollen für wissenschaftliches Schreiben und Begutachtung" width="100%" />
</div>
<p align="center"><em>Wähle eine Rolle für die aktuelle Aufgabe, vom wissenschaftlichen Schreiben und Bearbeiten von Dokumenten bis zur kritischen Begutachtung und Abbildungsarbeit.</em></p>
...
Das gebündelte `research-core`-Paket enthält 36 Skills. Die folgenden Namen sind die IDs, die der Katalog und die Projekteinstellungen verwenden.

| Kategorie | Skills |
| --- | --- |
| Recherche und Literatur | `citation-management`, `exploratory-data-analysis`, `hypothesis-generation`, `literature-review`, `oleafly-literature-sweep`, `oleafly-research-loop`, `openresearch`, `paper-lookup`, `research-lookup`, `scientific-brainstorming`, `scientific-critical-thinking` |
| Manuskripterstellung und Analyse | `experimental-design`, `oleafly-data-analysis`, `oleafly-manuscript-scaffold`, `oleafly-related-work`, `scientific-writing`, `statistical-analysis`, `statistical-power`, `venue-templates` |
| Abbildungen und Visualisierung | `oleafly-figure-prep`, `scientific-schematics`, `scientific-visualization` |
| Review und Evidenz | `oleafly-response-letter`, `oleafly-review-manuscript`, `oleafly-verify-claims`, `peer-review`, `scholar-evaluation` |
| Einreichung | `oleafly-pre-submission` |
| Kommunikation | `oleafly-slides-and-posters`, `pptx-posters`, `research-grants`, `scientific-slides` |
| Import- und Build-Werkzeuge | `import-refine`, `oleafly-latex-build`, `pdf-to-latex`, `template-generate` |

<p align="center">
  <img src="../assets/readme/skills.png" alt="Oleafly-KI-Assistenten mit einem Bereich für wiederverwendbare Recherchefähigkeiten" width="100%" />
</p>
<p align="center"><em>Skills machen aus einem nützlichen Rechercheablauf etwas, das du mit kompatiblen Agenten wiederverwenden und teilen kannst.</em></p>

### Mit MCP einen externen KI-Client verbinden
...
| Tool | Verwendung |
| --- | --- |
| PDF to LaTeX | Aus einem PDF bearbeitbares LaTeX rekonstruieren, wobei Mathematik, Abbildungen und Struktur erhalten bleiben, soweit die Quelle dies zulässt |
| arXiv to LaTeX | Ein arXiv-Quellpaket per ID herunterladen oder ein gespeichertes Archiv von der Festplatte entpacken |
| Image to LaTeX | Ein Bild mit Notizen, Gleichungen oder einer Tabelle in bearbeitbares LaTeX umwandeln |
| Equation to LaTeX | Getippten mathematischen Text oder ein Gleichungsbild in LaTeX konvertieren |
| Excel to LaTeX | Ein Excel-, CSV- oder TSV-Blatt in eine maskierte LaTeX-Tabelle konvertieren |
| HTML to LaTeX | Eingefügtes HTML in ein eigenständiges LaTeX-Dokument konvertieren |
| Image to Typst | Ein Bild mit Notizen, Gleichungen oder einer Tabelle in bearbeitbares Typst umwandeln |
| LaTeX to HTML | LaTeX mit MathML-Gleichungen in eigenständiges HTML konvertieren |
| LaTeX to Image | Eine Gleichung rendern und als PNG oder SVG exportieren |
| LaTeX to Markdown | Ein LaTeX-Dokument in portables Markdown konvertieren |
| LaTeX to Typst | LaTeX in Typst-Quelltext konvertieren, den du kopieren, speichern oder als Projekt öffnen kannst |
| LaTeX to Word | Ein Word-Dokument erstellen, dessen Gleichungen als native Word-Mathematik gespeichert werden |
| Markdown to LaTeX | Markdown-Notizen in ein eigenständiges LaTeX-Dokument konvertieren |
| Markdown to Typst | Markdown-Notizen in Typst-Quelltext konvertieren |
| Mermaid to LaTeX | Ein Mermaid-Flussdiagramm in bearbeitbaren TikZ-Code konvertieren |
| PDF to Markdown | Textebene, Gleichungen und Abbildungen eines PDFs in Markdown extrahieren |
| PDF to Typst | Textebene, Gleichungen und Abbildungen eines PDFs in Typst extrahieren |
| Table to LaTeX | Eine LaTeX-Tabelle in einem visuellen Editor für Zeilen und Spalten erstellen |
...
| Tool | Verwendung |
| --- | --- |
| Find Citations | Wissenschaftliche Indizes durchsuchen, einen Entwurf auf fehlende Belege prüfen und BibTeX exportieren |
| arXiv Citation Generator | Eine arXiv-Arbeit suchen und ihr Zitat in acht Stilen formatieren |
| Bibliography Generator | Eine Bibliografie aus strukturierten Angaben oder BibTeX erstellen, validieren, sortieren und exportieren |
| Citation Generator | Aus Artikeldetails oder einer wissenschaftlichen Kennung ein formatiertes Zitat und BibTeX erstellen |
| Citation Generators by Style | Eine Referenz in APA, MLA, Chicago, IEEE, Harvard, Vancouver, AMA und ACS vergleichen |
| DOI to BibTeX | Einen DOI-Datensatz abrufen, seine Felder prüfen und BibTeX exportieren |
| ISBN to BibTeX | Buchmetadaten per ISBN abrufen, korrigieren und exportieren |
...
<p align="center"><em>Führe Projektbefehle in einem Terminal-Tab aus, ohne den Editor- und PDF-Arbeitsbereich zu verlassen.</em></p>
...
## Typische Recherche-Workflows

| Anwendungsfall | Wie Oleafly hilft |
| --- | --- |
| Erste Arbeit | Mit einer Artikelvorlage beginnen, mit sichtbarer Gliederung schreiben und dabei kompilieren |
| Dissertation | Kapitel, Abbildungen, Referenzen und Anhänge in einem indizierten Projekt behalten und Checkpoints zur Wiederherstellung nutzen |
...
| Labor- oder Teamassistent | Isolierte Research Tasks, einen CLI-Agenten oder den localhost-MCP-Server mit Freigabesteuerung verwenden |

## Oleafly herunterladen

Für immer kostenlos · Open Source · Keine Konten · Keine Anmeldung · Kein Tracking

| Plattform | Paket | Download |
| --- | --- | --- |
...
- [Produktanleitungen](https://oleafly.com/docs/)
- [Funktionsübersicht](../features.md)
- [Editor-Leitfaden](../Editor.md)
- [PDF-Vorschau](../PDFPreview.md)
- [Zitate und Literatur](../Citations.md)
- [Tools-Galerie](../Tools.md)
- [Preflight- und Barrierefreiheitsprüfungen](../Preflight.md)
- [Vorlagen](../Templates.md)
- [Diagram Composer](../DiagramComposer.md)
- [Git und Source Control](../SourceControl.md)
- [Checkpoints](../Checkpoints.md)
- [KI-Copilot](../AICopilot.md)
- [Skills](../Skills.md)
...
Stelle Fragen, teile Ideen und diskutiere Recherche-Workflows in den [GitHub Discussions](https://github.com/Oleafly/Oleafly/discussions). Melde einen Fehler oder wünsche dir eine Funktion in den [GitHub Issues](https://github.com/Oleafly/Oleafly/issues).

Oleafly wird von [Prajwal Murthy](https://github.com/prajwal-svm) und Mitwirkenden entwickelt. Beiträge zu Code, Vorlagen, Dokumentation und Feedback sind willkommen. Lies den [Leitfaden zum Mitwirken](../../CONTRIBUTING.md), wenn du dich beteiligen möchtest.

Wenn du Oleafly nutzt, hilft ein [GitHub-Stern](https://github.com/Oleafly/Oleafly) anderen Forschenden, es zu finden.

## Oleafly zitieren

<details>
<summary>Den BibTeX-Eintrag kopieren</summary>
...
[Sicherheit](../../SECURITY.md) · [Verhaltenskodex](../../CODE_OF_CONDUCT.md) · [AGPL-3.0-or-later](../../LICENSE)
...
<a href="https://www.star-history.com/?repos=Oleafly%2FOleafly&type=date&legend=top-left">
 <picture>
   ...
   <img alt="Star-Verlaufsdiagramm" src="https://api.star-history.com/chart?repos=Oleafly/Oleafly&type=date&legend=top-left&sealed_token=aHz2JA-SBvmD73PyT7aCcCqMyAUvCPtidSAAvsQQxR8-1xdB-RZ-oXHKRnqIJUfSICl6Dd3_XPcHgb5Menvk_FfalfMb1GRbJC_TdeTMBVDi3jVUIXBBdovZ4dufhj4JWF3UXptJhw8pGmB6lqQ-X7gDOWu_bkPTQ7k-Q0VeBiq_jNgwRb7RSMgrSb-P" />
 </picture>
</a>
