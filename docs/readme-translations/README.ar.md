...
تُحفظ مفاتيح الواجهات البرمجية (API Keys) محلياً، كما تظل مستنداتك الأصلية بصيغ مفتوحة تتيح لك قراءتها وتعديلها بحرية تامة حتى وإن توقفت عن استخدام Oleafly مستقبلاً.
