...
[![Problemas abertos](https://img.shields.io/github/issues/Oleafly/Oleafly?label=issues&color=22c55e)](https://github.com/Oleafly/Oleafly/issues) [![Downloads](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2FOleafly%2FOleafly%2Fbadges%2F.github%2Fbadges%2Fdownloads.json)](https://github.com/Oleafly/Oleafly/releases) [![CI](https://github.com/Oleafly/Oleafly/actions/workflows/release.yml/badge.svg)](https://github.com/Oleafly/Oleafly/actions/workflows/release.yml) [![Quality Gate do SonarQube](https://sonarcloud.io/api/project_badges/measure?project=Oleafly_Oleafly&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=Oleafly_Oleafly) [![Cobertura de código](https://sonarcloud.io/api/project_badges/measure?project=Oleafly_Oleafly&metric=coverage)](https://sonarcloud.io/component_measures?id=Oleafly_Oleafly&metric=coverage) [![Estado de desenvolvimento: muito ativo](https://img.shields.io/badge/status-highly_active-22c55e)](https://github.com/Oleafly/Oleafly/pulse) [![Último commit](https://img.shields.io/github/last-commit/Oleafly/Oleafly?label=last%20commit&color=22c55e)](https://github.com/Oleafly/Oleafly/commits/main) [![Licença: AGPL v3](https://img.shields.io/badge/License-AGPL_v3-22c55e.svg)](../../LICENSE) [![Estrelas](https://img.shields.io/github/stars/Oleafly/Oleafly?style=social)](https://github.com/Oleafly/Oleafly)

**Escreva seu próximo artigo com menos trabalho repetitivo em um espaço de trabalho científico moderno.**

Oleafly é um aplicativo gratuito e de código aberto para escrever artigos de pesquisa. Use-o para artigos, teses, relatórios, apresentações, livros, currículos e outros documentos técnicos. Trabalhe em LaTeX, Typst ou Markdown. O código-fonte, o PDF, as citações, as figuras, as verificações, o histórico do Git e as ferramentas opcionais de IA permanecem no mesmo projeto.

<p>
  <a href="https://github.com/Oleafly/Oleafly/releases/latest"><strong>Baixar gratuitamente</strong></a>
· <a href="https://oleafly.com/docs/">Ler os guias</a> · <a href="../development.md">Compilar a partir do código-fonte</a>
</p>

Gratuito para sempre · Código aberto · Sem contas · Sem cadastro · Sem rastreamento

</div>

<div align="center">
  <img src="../assets/readme/hero.png" alt="Espaço de trabalho do Oleafly com um projeto LaTeX, editor de código-fonte, prévia do PDF e painel de planejamento de IA" width="100%" />
</div>
...
| Criando uma figura ou tabela | Diagram Composer, LaTeX Preview, Image to LaTeX ou LaTeX Table Generator |
...
<p align="center"><em>Comece pelo tipo de trabalho que você realmente tem: um projeto de pesquisa novo, um projeto existente ou um modelo.</em></p>

## Por que Oleafly

A maioria dos fluxos de escrita científica é uma sequência de ferramentas separadas: editor, compilador, leitor de PDF, gerenciador de bibliografia, ferramenta de diagramas, Git, lista de verificação e talvez um chat de IA que não consegue ver o projeto. O trabalho se espalha por várias janelas justamente quando o argumento fica mais complexo.

Oleafly reúne essas ferramentas em torno de um projeto. O código-fonte continua sendo texto simples. O PDF fica ao lado dele. Você pode encontrar uma citação a partir da frase que está escrevendo, manter uma figura em TikZ e revisar as alterações do assistente antes que cheguem ao projeto.

### Três formas de trabalhar

| Fluxo | O que oferece | O que ainda fica por sua conta |
| --- | --- | --- |
| Editor na nuvem hospedado | Configuração rápida, acesso pelo navegador e um serviço gerenciado | Confiar em uma camada de dados hospedada e adaptar seu fluxo aos limites dela |
| Pilha local autogerenciada | Controle sobre arquivos, ferramentas e infraestrutura | Escolher, instalar, configurar e manter cada peça |
| Oleafly | Um espaço de trabalho desktop local com editor, mecanismos, PDF, citações, figuras, verificações, Git e agentes opcionais no mesmo lugar | Coedição ao vivo e sincronização em segundo plano entre dispositivos ainda não estão disponíveis nesta versão |

Oleafly oferece um espaço de trabalho guiado sem colocar o manuscrito atrás de um formato proprietário ou de um serviço permanente.

## O que permanece no seu computador
...
<p align="center"><em>As conexões com provedores são explícitas e permanecem separadas do manuscrito no disco.</em></p>
...
<div align="center">
  <img src="../assets/readme/template-downloads.png" alt="Downloads de modelos do Oleafly com pacotes acadêmicos, Beamer e de conferências" width="100%" />
</div>
...
<p align="center"><em>Traga um projeto ou documento existente para um espaço de trabalho local comum.</em></p>

### Cada projeto é uma pasta acessível no seu disco

A biblioteca do Oleafly registra a identidade do projeto, o mecanismo, o tipo de documento, os favoritos, o estado da prévia e o histórico. O manuscrito continua sendo um diretório normal. Você pode abrir a fonte em outro editor, inspecioná-la no terminal, compartilhá-la com um coautor ou versioná-la com Git. O Oleafly não precisa de um banco de dados proprietário para compilar seu trabalho.

O aplicativo mantém seus artefatos de compilação e metadados locais separados da fonte. Um projeto pode guardar suas escolhas de mecanismo e documento principal em project.json, para que um clone ou arquivo de fonte exportado abra com as mesmas configurações.

<div align="center">
  <img src="../assets/readme/project-library.png" alt="Biblioteca de projetos do Oleafly com projetos de pesquisa organizados em uma lista pesquisável" width="100%" />
</div>

## Escreva o artigo e mantenha sua estrutura

### Um editor de código-fonte para documentos estruturados

O editor CodeMirror usa um índice de todo o projeto. O índice cobre títulos, labels, chaves de citação, macros, ambientes, arquivos incluídos e diagnósticos de compilação em todo o manuscrito.
...
<p align="center"><em>Monte um documento LaTeX estruturado pela barra de ferramentas e continue editando a fonte diretamente.</em></p>
...
| --- | ---: | --- |
| Grego minúsculo | 29 | alpha, beta, gamma, delta, epsilon, varepsilon, zeta, eta, theta, vartheta, iota, kappa, lambda, mu, nu, xi, pi, varpi, rho, varrho, sigma, varsigma, tau, upsilon, phi, varphi, chi, psi, omega |
| Grego maiúsculo | 11 | Gamma, Delta, Theta, Lambda, Xi, Pi, Sigma, Upsilon, Phi, Psi, Omega |
| Operadores | 19 | mais, menos, times, div, cdot, pm, mp, ast, star, circ, bullet, oplus, ominus, otimes, odot, dagger, ddagger, nabla, partial |
| Relações | 21 | igual, neq, menor, maior, leq, geq, ll, gg, approx, sim, simeq, cong, equiv, propto, prec, succ, preceq, succeq, perp, parallel, mid |
| Setas | 23 | leftarrow, rightarrow, uparrow, downarrow, leftrightarrow, Leftarrow, Rightarrow, Uparrow, Downarrow, Leftrightarrow, mapsto, longmapsto, longrightarrow, longleftarrow, hookrightarrow, hookleftarrow, nearrow, searrow, nwarrow, swarrow, rightleftharpoons, leftharpoonup, rightharpoonup |
| Teoria dos conjuntos | 19 | in, notin, ni, subset, supset, subseteq, supseteq, cup, cap, bigcup, bigcap, setminus, emptyset, varnothing, N, Z, Q, R, C |
| Lógica | 16 | forall, exists, nexists, neg, land, lor, wedge, vee, implies, iff, therefore, because, top, bot, vdash, models |
| Cálculo | 18 | int, iint, iiint, oint, sum, prod, coprod, lim, infty, nabla, partial, sqrt, frac, binom, sup, inf, max, min |
| Funções | 19 | sin, cos, tan, cot, sec, csc, arcsin, arccos, arctan, sinh, cosh, tanh, log, ln, exp, det, dim, ker, arg |
| Colchetes | 16 | parênteses, colchetes, chaves, angle, floor, ceiling, barra vertical, left e right |
| Acentos | 14 | hat, bar, tilde, vec, dot, ddot, acute, grave, breve, check, overline, underline, overbrace, underbrace |
| Pontos e espaçamento | 13 | cdots, ldots, vdots, ddots, quad, qquad, espaços, text, mathrm, mathbf, mathcal |
| Diversos | 20 | hbar, ell, wp, Re, Im, aleph, angle, triangle, diamond, square, lozenge, clubsuit, diamondsuit, heartsuit, spadesuit, grau, hash, dólar, porcentagem, e comercial |

<div align="center">
  <img src="../assets/readme/latex-symbols.png" alt="Paleta de símbolos LaTeX do Oleafly com categorias pesquisáveis para letras gregas, operadores, relações, setas, conjuntos, lógica, cálculo, funções, colchetes, acentos, espaçamento e outros símbolos" width="100%" />
</div>
<p align="center"><em>Pesquise 236 comandos LaTeX únicos por categoria ou nome e insira o que precisa.</em></p>

<div align="center">
  <img src="../assets/readme/source-and-pdf.png" alt="Oleafly mostrando a fonte de um manuscrito e o PDF compilado juntos" width="100%" />
</div>
...
<p align="center">
  <img src="../assets/readme/visual-editor.png" alt="Editor visual do Oleafly mostrando um manuscrito orientado por páginas, árvore de arquivos e esquema" width="100%" />
</p>

### Revise a prosa localmente
...
<div align="center">
  <img src="../assets/readme/compile-engines.png" alt="Configurações de mecanismos do Oleafly mostrando LaTeX, Typst, Markdown e distribuições TeX gerenciadas" width="100%" />
</div>
...
No modo de documento, o Oleafly divide a seleção ou o manuscrito em parágrafos, pesquisa fontes configuradas, remove artigos já presentes na bibliografia e classifica os demais de 0 a 100. Um provedor de IA pode acrescentar uma justificativa curta a favor ou contra. Sem IA, a classificação usa heurística local.

Salve resultados na biblioteca local, copie BibTeX ou acrescente uma entrada à bibliografia do projeto e insira sua citação.

### Revise um artigo com duas vozes

O modo de revisão pode usar um provedor configurado para ler o documento ou uma seleção capturada em dois estilos:

- Amigável: começa pelos pontos fortes e segue com sugestões específicas.
- Rigoroso: um teste de estresse no estilo Reviewer #2 para afirmações, métodos e evidências.

A revisão é uma ação opcional do assistente e não substitui as diretrizes do venue nem um coautor humano.

### Mantenha as pastas de pesquisa ao lado do manuscrito

Vincule um conjunto de dados, biblioteca de fontes, pasta de análise ou outro diretório sem movê-lo para o projeto. O Oleafly lê pastas vinculadas e nunca escreve nelas. Elas ficam fora da compilação, da busca e do Git.
...
| --- | --- |
| Compilação e layout | Builds falhos, citações e referências não resolvidas, glifos ausentes, caixas estouradas, texto cortado, destinos duplicados e tamanhos de página misturados |
| Prontidão para submissão | Classe do documento, resumo, palavras-chave, formatos de figura, fontes incorporadas, versão e restrições do PDF, nomes portáteis, legendas e pacote de fonte limpo |
| Prontidão para ATS | Extração de texto do currículo, campos de contato, seções esperadas, tamanho e layouts que confundem sistemas de rastreamento |
| Acessibilidade | Tags, texto alternativo, idioma e título, configurações do visualizador, estrutura, descrições de links, ordem de leitura, texto selecionável e marcadores |
| Referências e recursos | Arquivos ausentes, citações e referências indefinidas, labels e DOIs duplicados, campos bibliográficos incompletos, entradas não citadas e figuras ausentes |
| Privacidade e revisão cega | Credenciais, chaves privadas, arquivos sensíveis, marcação de rascunho, comentários internos, campos de autor e metadados do PDF |
...
<div align="center">
  <img src="../assets/readme/preflight-accessibility.png" alt="Verificações de acessibilidade do Preflight no Oleafly mostrando resultados verificáveis por máquina" width="100%" />
</div>
<p align="center"><em>O Preflight torna visíveis os resultados de acessibilidade verificáveis por máquina antes da submissão; ele não declara conformidade sozinho.</em></p>

## Versione e recupere seu trabalho
...
<p align="center"><em>Veja alterações preparadas, branches, histórico e commits sem sair do projeto.</em></p>

### Use checkpoints para recuperação rápida

Depois de uma compilação bem-sucedida, o Oleafly pode salvar um snapshot local do projeto. Checkpoints não inicializam um repositório, criam commits nem alteram uma branch. Restaure um estado anterior, nomeie uma versão, inspecione arquivos, remova histórico antigo ou mova uma história completa em arquivo criptografado.

Use Git para commits, branches, remotos e colaboração intencionais. Use checkpoints para recuperação local rápida enquanto o artigo muda depressa.

<div align="center">
  <img src="../assets/readme/checkpoints.png" alt="Painel de versionamento do Oleafly mostrando checkpoints salvos e histórico do Git" width="100%" />
</div>

## A IA é opcional

O editor, o compilador, a prévia do PDF, as citações, a revisão de texto e o Preflight funcionam com a IA desligada. Quando ativada, a IA usa os mesmos arquivos e ferramentas do projeto.

### Pergunte a um assistente sobre o projeto aberto

Com um provedor configurado, o assistente pode:

- Ler um arquivo ou pesquisar o projeto antes de responder.
- Explicar uma seção, equação, citação ou erro de compilação.
...
<div align="center">
  <img src="../assets/readme/ai-personas.png" alt="Personas do AI Assistant do Oleafly para escrita e revisão de pesquisa" width="100%" />
</div>
<p align="center"><em>Escolha uma função para a tarefa do momento, da escrita de pesquisa e edição documental à revisão crítica e ao trabalho com figuras.</em></p>
...
O pacote research-core incluído traz 36 skills. Os nomes abaixo são os IDs usados pelo catálogo e nas configurações do projeto.

| Categoria | Skills |
| --- | --- |
| Pesquisa e literatura | citation-management, exploratory-data-analysis, hypothesis-generation, literature-review, oleafly-literature-sweep, oleafly-research-loop, openresearch, paper-lookup, research-lookup, scientific-brainstorming, scientific-critical-thinking |
| Autoria e análise de manuscritos | experimental-design, oleafly-data-analysis, oleafly-manuscript-scaffold, oleafly-related-work, scientific-writing, statistical-analysis, statistical-power, venue-templates |
| Figuras e visualização | oleafly-figure-prep, scientific-schematics, scientific-visualization |
| Revisão e evidências | oleafly-response-letter, oleafly-review-manuscript, oleafly-verify-claims, peer-review, scholar-evaluation |
| Submissão | oleafly-pre-submission |
| Comunicação | oleafly-slides-and-posters, pptx-posters, research-grants, scientific-slides |
| Importação e ferramentas de build | import-refine, oleafly-latex-build, pdf-to-latex, template-generate |

<p align="center">
  <img src="../assets/readme/skills.png" alt="Painel de skills do AI Assistant do Oleafly mostrando recursos de pesquisa reutilizáveis" width="100%" />
</p>
<p align="center"><em>Skills transformam uma rotina de pesquisa útil em algo que você pode reutilizar e compartilhar com agentes compatíveis.</em></p>

### Conecte um cliente de IA externo com MCP
...
| Ferramenta | Use para |
| --- | --- |
| PDF to LaTeX | Reconstruir LaTeX editável a partir de PDF, preservando matemática, figuras e estrutura quando a fonte permite |
| arXiv to LaTeX | Baixar um pacote de fonte do arXiv por ID ou desempacotar um arquivo salvo no disco |
| Image to LaTeX | Transformar uma imagem de notas, equações ou tabela em LaTeX editável |
| Equation to LaTeX | Converter matemática digitada ou uma imagem de equação em LaTeX |
| Excel to LaTeX | Converter uma planilha Excel, CSV ou TSV em uma tabela LaTeX com escapes |
| HTML to LaTeX | Converter HTML colado em um documento LaTeX independente |
| Image to Typst | Transformar uma imagem de notas, equações ou tabela em Typst editável |
| LaTeX to HTML | Converter LaTeX em HTML independente com equações MathML |
| LaTeX to Image | Renderizar uma equação e exportar PNG ou SVG |
| LaTeX to Markdown | Converter um documento LaTeX em Markdown portátil |
| LaTeX to Typst | Converter LaTeX em fonte Typst para copiar, salvar ou abrir como projeto |
| LaTeX to Word | Criar um documento Word com equações como matemática nativa |
| Markdown to LaTeX | Converter notas Markdown em um documento LaTeX independente |
| Markdown to Typst | Converter notas Markdown em fonte Typst |
| Mermaid to LaTeX | Converter um fluxograma Mermaid em código TikZ editável |
| PDF to Markdown | Extrair texto, equações e figuras de um PDF para Markdown |
| PDF to Typst | Extrair texto, equações e figuras de um PDF para Typst |
| Table to LaTeX | Criar uma tabela LaTeX em um editor visual de linhas e colunas |
...
| Ferramenta | Use para |
| --- | --- |
| Find Citations | Pesquisar índices acadêmicos, encontrar suporte ausente e exportar BibTeX |
| arXiv Citation Generator | Consultar um artigo do arXiv e formatar sua citação em oito estilos |
| Bibliography Generator | Criar, validar, ordenar e exportar uma bibliografia de detalhes estruturados ou BibTeX |
| Citation Generator | Transformar detalhes de artigo ou identificador em citação formatada e BibTeX |
| Citation Generators by Style | Comparar uma referência em APA, MLA, Chicago, IEEE, Harvard, Vancouver, AMA e ACS |
| DOI to BibTeX | Recuperar um registro DOI, revisar seus campos e exportar BibTeX |
| ISBN to BibTeX | Recuperar metadados por ISBN, corrigi-los e exportar BibTeX |
...
<p align="center"><em>Execute comandos do projeto em uma aba de terminal sem sair do editor e do espaço de trabalho do PDF.</em></p>
...
## Fluxos comuns de pesquisa

| Caso de uso | Como o Oleafly ajuda |
| --- | --- |
| Primeiro artigo | Começar por um modelo de artigo, escrever com o esquema visível e compilar durante o trabalho |
| Tese ou dissertação | Manter capítulos, figuras, referências e apêndices em um projeto indexado com checkpoints |
...
| Assistente de laboratório ou equipe | Usar Research Tasks isoladas, um agente CLI ou MCP em localhost com controles de aprovação |

## Baixar o Oleafly

Gratuito para sempre · Código aberto · Sem contas · Sem cadastro · Sem rastreamento

| Plataforma | Pacote | Download |
| --- | --- | --- |
...
- [Guias do produto](https://oleafly.com/docs/)
- [Mapa de recursos](../features.md)
- [Guia do editor](../Editor.md)
- [Prévia do PDF](../PDFPreview.md)
- [Citações e literatura](../Citations.md)
- [Galeria de ferramentas](../Tools.md)
- [Preflight e acessibilidade](../Preflight.md)
- [Modelos](../Templates.md)
- [Diagram Composer](../DiagramComposer.md)
- [Git e controle de código-fonte](../SourceControl.md)
- [Checkpoints](../Checkpoints.md)
- [AI Copilot](../AICopilot.md)
- [Skills](../Skills.md)
- [Integração MCP](../mcp.md)
...
Faça perguntas, compartilhe ideias e converse sobre fluxos de pesquisa nas [Discussões do GitHub](https://github.com/Oleafly/Oleafly/discussions). Relate um bug ou solicite um recurso nas [Issues do GitHub](https://github.com/Oleafly/Oleafly/issues).

Oleafly é desenvolvido por [Prajwal Murthy](https://github.com/prajwal-svm) e colaboradores. Contribuições para código, modelos, documentação e feedback são bem-vindas. Leia o [guia de contribuição](../../CONTRIBUTING.md).

Se você usa o Oleafly, uma [estrela no GitHub](https://github.com/Oleafly/Oleafly) ajuda outros pesquisadores a encontrá-lo.

## Citar Oleafly

<details>
<summary>Copiar a entrada BibTeX</summary>
...
[Segurança](../../SECURITY.md) · [Código de Conduta](../../CODE_OF_CONDUCT.md) · [AGPL-3.0-or-later](../../LICENSE)
